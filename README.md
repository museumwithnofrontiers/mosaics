...
The **Museum With No Frontiers — Mosaics** gallery, built from the published
dataset `@museumwnf/mosaics-data`.
...
| Package | Role |
| --- | --- |
| `@museumwnf/mosaics-data` | the dataset (JSON + `manifest.json`) |
...
<https://museumwithnofrontiers.github.io/mosaics/> through the reusable workflows in

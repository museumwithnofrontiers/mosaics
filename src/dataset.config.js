...
export default {
  ...
  home: {
    title: 'mosaics.identity.title',
    intro: 'mosaics.home.intro',
    cards: [
      {
        title: 'mosaics.nav.catalogue',
        description: 'mosaics.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'mosaics.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'mosaics.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'mosaics.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //
  //   extraViews: [
  //     ...standardRoutes('gallery', { creditsBody: 'mosaics.credits.body' }),
  ...
  //       partnerObjects: {
  //         emptyPartner: 'mosaics.partnerObjects.emptyPartner',
  //         emptyInstitution: 'mosaics.partnerObjects.emptyInstitution',
  //         institutionSummary: 'mosaics.partner.monumentsInExhibition',
  //         partnerProfileLabel: 'mosaics.partnerObjects.partnerProfile',
  //         institutionProfileLabel: 'mosaics.partnerObjects.institutionProfile',
  //       },
  //     }),
  //     // + this website's own routes: home, item, collection entrance,
  //     // timeline entrance, partners entrance

...
export default {
  ...
  // one entry for every project id `npm pack @museumwnf/mosaics-data`
  // carries in `manifest.projects` (checked 2026-09-19, mosaics-data 1.0.9).
  ...
  site: { origin: 'https://museumwithnofrontiers.github.io/mosaics' },

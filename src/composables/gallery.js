...
// `useGalleryData.js` used to be byte-identical local copies of what mosaics
...
// legacy project key, no UUID — mosaics shares the same entity list and
...
export const itemSheet = {
  ...
  related: {
    ...
    // Since inventory-app#1807 (mosaics-data 1.0.11+), an outside
